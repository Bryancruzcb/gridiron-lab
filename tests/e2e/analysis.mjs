...
const lockBtn = (page, id) => page.locator(`tr[data-player-id="${id}"]`).locator("button").nth(0);
/** @param {Page} page @param {string} id */
const benchBtn = (page, id) => page.locator(`tr[data-player-id="${id}"]`).locator("button").nth(1);
/** @param {Page} page */
