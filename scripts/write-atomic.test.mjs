...
// The og skill is a Grok workspace file that .gitignore (`.grok/*`) keeps out of
// this repo, so a clone or CI checkout has nothing to pin. The argument and
// staging rules it quotes keep their own tests above.
const OG_SKILL_DIR = join(TEMPLATE_ROOT, ".grok/skills/og");
const OG_SKILL_ABSENT =
  !existsSync(join(OG_SKILL_DIR, "SKILL.md")) || !existsSync(join(OG_SKILL_DIR, "references"));

test(
  "every hand-over the og skill prints is one this script accepts",
  { skip: OG_SKILL_ABSENT && "gitignored .grok/skills/og is not in this checkout" },
  () => {
